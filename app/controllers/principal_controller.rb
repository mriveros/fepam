...
class PrincipalController < ApplicationController
  ...
  def index
    ...
    cant_voto_otro_candidato = RegistroVoto.where('voto_candidato = ?', false)
    ...
    #Porcentaje votos
    #cantidad_votantes = Votante.all.count
    #cantidad_registro_voto = RegistroVoto.all.count
    @porcentaje_voto = RegistroVoto.voto_percentage.to_f
  ...
  def guardar_usuario
    ...
    if persona.present?
      ...
      persona = Persona.new
      persona.documento_persona = params[:persona_documento]
      persona.nombre_persona = params[:persona_nombre]
      persona.apellido_persona = params[:persona_apellido]
      ...
      persona.correo_electronico = params[:usuario][:email]
      if persona.save
        ...
        valido = false
      @msg += "Persona no encontrada.<br />ENVIE SU NRO DE DOCUMENTO Y CORREO ELECTRONICO AL CORREO marcos.riveros@smarthub.com.py para realizar verificaciones."
