class ApplicationController < ActionController::Base
  ...
  helper_method :current_usuario_session, :current_usuario, :quita_acentos, :rol_tutor, :rol_docente, :rol_director, :rol_supervisor, :rol_administrador,:rol_tecnico_becas_medias, :rol_operador
  ...
  def rol_operador
    perfil = VAcceso.where("usuario_id = ? and rol_id = ?", current_usuario.id, PARAMETRO[:rol_operador])
    perfil.present?
  end
