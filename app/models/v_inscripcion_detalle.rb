class VInscripcionDetalle < ActiveRecord::Base
  ...
  attr_accessible :inscripcion_detalle_id, :inscripcion_id ,:piloto_id, :precio_id, :monto_inscricion, :estado_inscripcion_detalle_id, :estado_inscripcion_detalle, :nombre_piloto, :fecha_inscripcion, :created_at, :updated_at
