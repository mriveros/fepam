  ...
  $.ajax({
    ...
    success: function(data){
      ...
      if(data != null){
        ...
        $("<span id='msg-documento-persona' style='color:red;padding-top:20px;font-size:10px;'>Esta persona no existe, comuniquese a marcos.riveros@smarthub.com adjuntando copia del documento de identidad para registrar la persona y habilitar la creación del usuario.</span>").insertAfter("#persona_documento");
...
function buscar_votante(cedula, ruta){
  ...
  $.ajax({
    ...
    success: function(data){
      ...
      if(data != null){
        ...
        $("#votante_id").val(data.id);
          
      }else{


        $("<span id='msg-documento-persona' style='color:red;padding-top:20px;font-size:10px;'>Votante no encontrado.</span>").insertAfter("#cedula");
